      ...
      <div style={{ background: 'white', padding: '20px 16px', borderBottom: '1px solid var(--border-color)' }}>
        ...
        <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
          ...
          <button 
            ...
            className="btn-secondary active-scale hover-lift" 
            style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px', padding: '10px', borderRadius: '12px', border: '1.5px solid #25D366', color: '#166534', background: '#F0FDF4', cursor: 'pointer', fontWeight: '800', fontSize: '0.85rem' }}
          >
            📲 Statut WhatsApp
          </button>
          ...
          <button 
            onClick={handleShare}
            className="btn-secondary active-scale" 
            style={{ padding: '10px 14px', borderRadius: '12px', border: '1.5px solid #E2E8F0', color: 'var(--text-main)', background: 'white', cursor: 'pointer' }}
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="18" cy="5" r="3"></circle><circle cx="6" cy="12" r="3"></circle><circle cx="18" cy="19" r="3"></circle><line x1="8.59" y1="13.51" x2="15.42" y2="17.49"></line><line x1="15.41" y1="6.51" x2="8.59" y2="10.49"></line></svg>
          </button>
        </div>
